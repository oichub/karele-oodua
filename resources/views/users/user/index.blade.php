        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-5">
              ...
              <!-- Profile Image -->
              <div id="profile">
              <div class="card card-primary card-outline collapse show " data-parent="#profile" id="profiledetails" >
                <div class="card-body box-profile">
                  ...
                  <ul class="list-group list-group-unbordered mb-3">
                    ...
                    <a href="#profileupdate" data-toggle="collapse" class="btn btn-primary btn-block">More</a>
                </div>
                <!-- /.card-body -->
              </div>
              <div class="card card-primary card-outline collapse" id="profileupdate" data-parent="#profile" >
                <div class="card-body box-profile">


                  <h3 class="profile-username text-center  text-uppercase">Update profile</h3>
                  ...
                  <form method="POST" action="{{ route('user.update', Auth::user()->id) }}">
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-md-12 col-form-label">{{ __('Phone Number') }}</label>

                        <div class="col-md-12">
                            <input id="phone" type="text" value="{{ $user->phone }}" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="name" autofocus>
                    ...
                    <div class="form-group row">
                        <label for="inputName2" class="col-md-12 col-form-label">Country of residence</label>
                        <div class="col-md-12">
                  ...
                  <a href="#profiledetails" data-toggle="collapse" class="btn btn-primary btn-block">Less</a>
