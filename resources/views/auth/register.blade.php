            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="inputName2" class="col-md-4 col-form-label text-md-right">Country of residence</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <div class="offset-sm-2 col-sm-10">
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="T&C" > I agree to the <a href="#">terms and conditions</a>
                              </label>
                              </div>
                              @if ($errors->has('T&C'))
                              <span class="text-danger" role="alert">
                                <strong>{{ $errors->first('T&C') }}</strong>
                              </span>
                              @endif
                            </div>
